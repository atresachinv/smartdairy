...
// //get total milk payment amt----------------------------------------------------->
// export const getMilkPayAmt = createAsyncThunk(
//   "payment/getMilkPayAmt",
//   async ({ fromDate, toDate }, { rejectWithValue }) => {
//     try {
...
// //get total milk payment amt----------------------------------------------------->
// export const savMilkPaydata = createAsyncThunk(
...
//         state.error = action.payload;
//       }) //fetch milk payment amt --------------------------------------------------------->
//       .addCase(getMilkPayAmt.pending, (state) => {
//         state.pzerostatus = "loading";
//         state.error = null;
//       })
//       .addCase(getMilkPayAmt.fulfilled, (state, action) => {
//         state.pzerostatus = "succeeded";
//         state.paymentData = action.payload;
//       })
//       .addCase(getMilkPayAmt.rejected, (state, action) => {
//         state.pzerostatus = "failed";
//         state.error = action.payload;
//       }) //Save fix deductions of milk payment ------------------------------------------->
//       .addCase(savMilkPaydata.pending, (state) => {
//         state.savepaystatus = "loading";
//         state.error = null;
//       })
//       .addCase(savMilkPaydata.fulfilled, (state) => {
//         state.savepaystatus = "succeeded";
//       })
//       .addCase(savMilkPaydata.rejected, (state, action) => {
