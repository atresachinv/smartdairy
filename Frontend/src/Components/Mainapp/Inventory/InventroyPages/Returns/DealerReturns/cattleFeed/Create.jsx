...
const CreateDealer = () => {
  ...
  return (
    <div className="dealer-return-container w100 h1 d-flex sb">
      <div className="retun-product-details-container w48 h1 d-flex-col p10 bg">
        <span className="heading h10"> {t("ps-addDealReturnCattleFeed")}</span>
      ...
      <div className="return-product-invoice-container w48 h1 d-flex-col bg">
        ...
        <div className="return-prod-invoice-details-table w100 h80 mh80 hidescrollbar d-flex-col">
