...
const MedList = () => {
  ...
  const downloadPdf = () => {
    ...
    const gepInfo = doc.getTextWidth("Medicines Customer Return Report");
    doc.text(
      "Medicines Customer Return Report",
      (pageWidth - gepInfo) / 2,
      margin + 35
    );
    ...
    // Save the PDF
    doc.save(
      `Medicines_Cust_Return_Report_${formatDateToDDMMYYYY(
        date1
  ...
  return (
    <div className="customer-return-prod-list-container w100 h1 d-flex-col">
      <span className="heading">उत्पादक औषधे परत :</span>
