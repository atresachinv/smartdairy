...
const CreateStock = () => {
  ...
  return (
    <div className="starting-stock-outer-container w100 h1 d-flex center">
      <div className="starting-stock-container w60 h75 d-flex-col sb bg p10">
        <span className="heading h10"> {t("ps-startingStock")}</span>
        <form
          className="starting-stock-form-container w100 h1 d-flex-col sb"
          onSubmit={handleSubmit}
        >
          <div className="stock-details-outer-container w100 h25 d-flex sb">
            <div className="stock-details-div w48 d-flex-col sa">
