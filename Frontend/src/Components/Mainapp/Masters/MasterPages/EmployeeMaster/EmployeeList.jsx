    ...
    <div className="emp-list-container w70 h90 d-flex-col">
      ...
      <div className="emp-data-list-container w100 h1 d-flex-col bg">
        <div className="data-heading-div w100 h10 d-flex a-center t-center sb bg2">
          ...
          <span className="f-label-text w15">Employee ID</span>
          <span className="f-label-text w30">Employee Name</span>
          <span className="f-label-text w20">Designation</span>
          <span className="f-label-text w15">Mobile</span>
          <span className="f-label-text w20">Salary</span>
        </div>
        <div className="emp-data-list-div w100 h90 mh90 d-flex-col hidescrollbar">
          {Emplist.map((emp, i) => (
            <div
              ...
              <span className="text w5">{i + 1}</span>
              <span className="text w15">{emp.emp_id}</span>
