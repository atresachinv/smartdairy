...
import { fetchMaxRcCode, listRateCharts, saveRateChart } from "../../../../../App/Features/Mainapp/Masters/rateChartSlice";

const SaveRateChart = ({ rate }) => {
  const dispatch = useDispatch();
  const tDate = useSelector((state) => state.date.toDate);
  const { rcsavestatus } = useSelector((state) => state.ratechart);
