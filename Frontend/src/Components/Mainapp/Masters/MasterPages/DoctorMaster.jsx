...
const DoctorMaster = () => {
  ...
  const handleAddorUpdateDr = async (e) => {
    ...
    if (!values.code || !values.drname) {
      toast.info("Please add doctor details!");
      return;
    }
  ...
  return (
    <div className="doctor-master-container w100 h1 d-flex-col sb p10">
      <span className="heading p10">
        {isEditMode ? "Edit Doctor" : "Add New Doctor"}
      </span>
      <form
        onSubmit={handleAddorUpdateDr}
        className="doctor-master-form-container w100 h15 d-flex a-center sb"
      >
        <div className="doctor-info-details-code w100 h1 d-flex a-center sb">
          <div className="doctor-details-code w10 d-flex-col sb">
          ...
          <div className="doctor-details-drname w30 d-flex-col sb">
          ...
          <div className="doctor-details-drname w30 d-flex-col sb">
            <label htmlFor="sname" className="label-text w">
              Doctor Short Name :
            </label>
            <input
              type="text"
      ...
      <div className="doctor-details-container w100 h80 mh80 hidescrollbar d-flex-col bg">
        <div className="doctor-details-headings w100 p10 d-flex a-center t-center sticky-top bg7 sa">
        ...
        {listStatus === "loading" ? (
          ...
          doctorList.map((doctor, index) => (
            <div
              key={index}
              className="doctor-details-headings w100 p10 d-flex a-center sa"
              style={{
                backgroundColor: index % 2 === 0 ? "#faefe3" : "#fff",
              }}
            >
              <span className="label-text w10">{doctor.drcode}</span>
              <span className="label-text w40 t-start">{doctor.drname}</span>
              <span className="label-text w20">{doctor.short_name}</span>
