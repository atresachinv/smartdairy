...
//         <h3 style="text-align: center;">City: ${CityName}</h3>
...
//                 }}
//               >
//                 <span className="info-text w10 ">{item.Code}</span>
//                 <span className="info-text w30 ">
//                   {item.customerName}
//                 </span>
//                 <span className="info-text w20 ">{item.dname}</span>
//                 <span className="info-text w20 t-end px10">
...
//             {/* 👉 Total Deduction Row */}
//             <div
//               className="deduction-total-row w100 h10 d-flex a-center sa"
//               style={{ fontWeight: "bold", backgroundColor: "#d6f5d6" }}
//             >
//               <span className="info-text w10 t-start"></span>
//               <span className="info-text w45 t-start">Total</span>
//               <span className="text w20 t-start"></span>
//               <span className="info-text w20 t-end px10">
//                 {filteredDeduction
//                   .reduce((acc, curr) => acc + (parseFloat(curr.AMT) || 0), 0)
//                   .toFixed(2)}
//               </span>
//             </div>
//           </>
        ...
        {status === "loading" ? (
          ...
          <>
            {filteredDeduction.map((item, index) => (
              ...
              >
                <span className="info-text w10 ">{item.Code}</span>
                <span className="info-text w30 ">{item.customerName}</span>
                <span className="info-text w20 ">{item.dname}</span>
                <span className="info-text w20 t-end px10">
                  {parseFloat(item.AMT || 0).toFixed(2)}
                </span>
