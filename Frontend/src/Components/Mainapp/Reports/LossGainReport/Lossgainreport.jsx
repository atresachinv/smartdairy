...
//   const dairyColl = useSelector((state) => state.milkCollection.dairyColl); // sangha Sales
...
//     dispatch(dairydailyLossGain({ fromDate, toDate }));
//     setShowTable(true);
//   };

//   console.log("sanghaMilkColl", sanghaMilkColl);
//   console.log("dairymilk", dairymilk);
//   console.log("dairyColl", dairyColl);
  ...
  return (
    <>
      <div className="loss-gain-report-container w60 h1 d-flex-col center">
        <span className="heading px10">Loss gain Report</span>
        <div className="first-loss-gain-report-div w100 h40 d-flex-col bg center br">
