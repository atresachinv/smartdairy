  ...
  return (
    <>
      <div className="deduction-list-container w100 h1 d-flex-col  bg ">
        ...
        <div className="deduction-list-first-half-div w100 h40 d-flex-col sa ">
          <div className="select-deduction-report w100 h25 d-flex a-center px10">
            <span className="label-text w10">कपात निवडा:</span>
            <select className="data w50" name="kapat" id=""></select>
          </div>
          <div className="deduction-list-from-to-date-div w100 h25 a-center px10 d-flex">
          ...
          <div className="code-number-from-to-div-and-button-div w100 h25 d-flex px10 ">
        ...
        <div className="deduction-list-table w100 h70 d-flex-col">
          <div className="deduction-heading-side-table w100 h10 sa d-flex">
          ...
          <div className="deduction-list-table-data w100 mx90 hidescrollbar sa d-flex">
