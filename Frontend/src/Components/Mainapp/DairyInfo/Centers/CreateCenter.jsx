  ...
  return (
    <div className="center-main-container w100 h1 d-flex center">
      <form
        ...
        <div className="center-name-div w100 h15 d-flex-col sa">
          <label htmlFor="center_name" className="info-text w100">English Name</label>
          <input
            className={`data w100 ${errors.date ? "input-error" : ""}`}
            type="text"
            name="center_name"
        ...
        <div className="center-add-data-div w100 h10 d-flex a-center sb">
          <div className="center-details-div center-data w20 d-flex-col sa">
            <label htmlFor="center_id" className="info-text w100">Center No.</label>
            <input
              className={`data w100 ${errors.date ? "input-error" : ""}`}
              type="number"
              name="center_id"
          ...
          <div className="center-details-div center-data w20 d-flex-col sa">
            <label htmlFor="auditclass" className="info-text w100">Audit Class</label>
            <input
              className={`data w100 ${errors.date ? "input-error" : ""}`}
              type="text"
              name="auditclass"
          ...
          <div className="center-details-div center-data w20 d-flex-col sa">
            <label htmlFor="reg_no" className="info-text w100">Register No.</label>
            <input
              className={`data w100 ${errors.date ? "input-error" : ""}`}
              type="number"
              name="reg_no"
          ...
          <div className="center-details-div center-data w30 d-flex-col sa">
            <label htmlFor="reg_date" className="info-text w100">Register Date</label>
            <input
              className={`data w100 ${errors.date ? "input-error" : ""}`}
              type="date"
              name="reg_date"
        ...
        <div className="center-add-data-div w100 h15 d-flex a-center sb">
          <div className="center-details-div w30 d-flex-col sa">
            <label htmlFor="mobile" className="info-text">Mobile</label>
            <input
              className={`data w100 ${errors.date ? "input-error" : ""}`}
              type="text"
              name="mobile"
        ...
        <div className="center-add-data-div w100 h10 d-flex a-center sb">
          <div className="center-details-div center-data w20 d-flex-col sa">
            <label htmlFor="city" className="info-text w100">City</label>
            <input
              className={`data w100 ${errors.date ? "input-error" : ""}`}
              type="text"
              name="city"
          ...
          <div className="center-details-div center-data w25 d-flex-col sa">
            <label htmlFor="tehsil" className="info-text w100">Tehsil</label>
            <input
              className={`data w100 ${errors.date ? "input-error" : ""}`}
              type="text"
              name="tehsil"
        ...
        <div className="add-data-div w100 h10 d-flex a-center my10 sb">
          ...
          <div className="center-pass-details-div w45">
            <label htmlFor="confirm_pass" className="text w100">
              Confirm Password
            </label>
