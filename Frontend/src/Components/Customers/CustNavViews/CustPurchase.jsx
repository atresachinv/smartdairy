...
const CustPurchase = () => {
  ...
  return (
    <div className="purchase-info-div w100 h1 d-flex-col p10">
      ...
      <div className="selection-conatiner w100 p10 d-flex center">
        <span className="w40 heading px10">Select Period</span>
        <select
          className="custom-select text w60 p10 mh80 d-flex-col hidescrollbar"
      ...
      <div className="purchase-details-container w100 h80 d-flex-col bg">
        ...
        {purchaseBill.length === 0 ? (
          <span className="heading">Data Not Found!</span>
        ) : (
          <>
